(function () {
    ...
    var defaultConfig = {
        ...
        //Boolean - Whether or not hovering should activate single bars or entire stacks
        singleTooltip: true,
    ...
    Chart.Type.extend({
        ...
        initialize:  function (data) {
            ...
            this.BarClass = Chart.Rectangle.extend({
                ...
                inRange: function (chartX, chartY) {
                    // Positioning for the single rectangle currently being hovered over.
        ...
        getBarsAtEvent: function (e) {
            var barsArray = [],
                singleTooltip = this.options.singleTooltip,
        ...
        showTooltip: function (ChartElements, forceRedraw) {
            var singleTooltip = this.options.singleTooltip;
